  ...
  <div>
    ...
    <div class="container-fluid row">
      ...
      <div class="col-2">
        ...
        <div class="container-fluid border p-2 w-100" style="border-radius: 10px">
          <div class="g-0 row">
            <div v-for="photo in photoContainer" :key="photo" class="col-3 m-2">
              <div
                class="DDimage d-flex"
                draggable="true"
                @drag="imgDown"
                @dragstart="addElement"
              ...
              >
                <img
                  width="35px"
                  height="35px"
                  class="btn btn-link border p-1 m-0"
                  draggable="false"
                  :src="'./' + photo"
                  onclick="event.preventDefault();"
                />
                <div
                  class="condition-positions px-0 mx-0 rounded border d-none"
        ...
        <div
          class="btn btn-outline border-danger bg-white text-danger py-3 mt-1 w-100"
          id="delzone"
          @drop="dropElement"
          @dragover="imgDown"
          @mouseover="onTrashMouseOver"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
...
export default {
  ...
  methods: {
    ...
    dropElement(e) {
      ...
      if (e.target === delzone && this.curEl.classList.contains("DDimage")) return;
