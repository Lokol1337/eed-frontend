    ...
    <div class="container-fluid my-5" style="height: 100%">
      <div class="impContainer" id="impContainer">
        ...
        <label for="photoImp" class="photoImp">
          <span class="material-symbols-outlined impSvg"> upload </span>
        </label>
      </div>
      ...
      <div id="canvasContainer" class="d-none"></div>

      <button
        id="button-cutImage"
        class="btn btn-outline-success mt-3 me-0 d-none"
        @click="cutPhoto"
      >
        Обрезать
      </button>
      ...
      <button
        id="button-nextPage"
        class="btn btn-primary me-0 d-none"
        @click="gotoElementEditor()"
      >
        Далее
      </button>
    </div>
...
export default {
  ...
  methods: {
    async gotoElementEditor() {
      ...
      this.$router.push({
        path: "elementEditor",
        query: { apparatId: this.apparatId, blockId: this.blockId },
      });
    },
    async send() {
    ...
    takeBorder(e) {
      ...
      document
        .getElementById("canvasBorders")
        .addEventListener("mousemove", this.moveBorder);
    },
    ...
    stopBorder(e) {
      ...
      document
        .getElementById("canvasBorders")
        .removeEventListener("mousemove", this.moveBorder, false);
    ...
    cutPhoto() {
      ...
      image.onload = () => {
        ...
        ctx.drawImage(
          ...
          left * v.koefWidth,
          top * v.koefHeight,
          this.canvasWidht * v.koefWidth,
          this.canvasHeight * v.koefHeight,
          0,
          0,
          this.canvasWidht,
          this.canvasHeight
